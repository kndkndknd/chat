import { cnvs, ctx, videoElement } from "../../frontend/src/globalVariable";

//const videoElement = <HTMLVideoElement>document.getElementById('video');
const cinemaElement = document.getElementById("cinema");
const bckcnvsElement = document.getElementById("bckcnvs");
const bckcnvsContext = bckcnvsElement.getContext("2d");
let emojiFlag = false;

export function textPrint(text, stx, strCnvs) {
  stx.fillStyle = "white";
...
export function eraseText(stx, strCnvs) {
  stx.clearRect(0, 0, strCnvs.width, strCnvs.height);
}

export function clearTextPrint(text, stx, strCnvs) {
  stx.clearRect(0, 0, strCnvs.width, strCnvs.height);
  print(text, stx, strCnvs);
}
...
export function canvasSizing() {
  ...
  console.log(width);
  console.log(height);
  const cnvsElement = document.getElementById("cnvs");
...
export function showImage(url, receive_ctx) {
  //canvasSizing()
