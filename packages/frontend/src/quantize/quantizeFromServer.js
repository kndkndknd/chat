import { streamFlagState, streamChunk, quantizeState, } from "../state";
...
export const quantizeFromServer = (data) => {
    ...
    const quantizeObj = setQuantize(data);
    ...
    const string = quantizeObj.flag
        ? `QUANTIZE:${quantizeObj.flag}, bpm:${60000 / (quantizeObj.bar / quantizeObj.beat)}, beat:${quantizeObj.beat}`
        : "QUANTIZE:false";
    // 文字表示
    textPrint(string);
    setTimeout(() => {
