...
const connectedClientView = (clients) =>{
  ...
  for(let key in clients){
    ...
    var lastRow = $('#clientList tbody > tr:last').after('<tr id="clientTd"><td>'+ clients[key]["type"] + '</td><td id="IdTd">' + clients[key]["No"] + '</td><td><input type="checkbox" id="CHAT_FROM" class="route" name="' + key
